...
use crate::base::operation::{Operations, Rotation};
use crate::base::point_group::{GeometricCrystalClass, PointGroup};

pub fn conventional_cell(primitive_cell: &Cell, operations: &Operations) -> Cell {
    let point_group = PointGroup::new(primitive_cell.lattice.clone(), operations.rotations.clone());
...
fn identify_geometric_crystal_class(point_group: &PointGroup) -> Option<GeometricCrystalClass> {
